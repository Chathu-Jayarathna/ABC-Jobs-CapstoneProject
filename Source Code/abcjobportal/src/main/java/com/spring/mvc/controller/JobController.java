...
import com.spring.mvc.servic.UserServiceImpl;
...
//Update job
	...
	@RequestMapping(value = "/delete_apply_job/{id}")
	public String delete_apply_job(@PathVariable("id") Long id) {
		applyJobRepository.deleteApplyJobById(id);
